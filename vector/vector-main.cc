 ...
 * @author F. de Sande
 * @date Nov 28, 2022
 * @brief Shows floating point arithmeticsEste programa genera un vector con size componentes y ejecuta nuemros aleatorios dentro de los intervalos, dicho por el usuario
